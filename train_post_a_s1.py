...
from mmt import models_post_a_s1
...
def create_model(args):
    model_1 = models_post_a_s1.create(args.arch, num_features=args.features, dropout=args.dropout, num_classes=args.num_clusters)
    model_2 = models_post_a_s1.create(args.arch, num_features=args.features, dropout=args.dropout, num_classes=args.num_clusters)

    model_1_ema = models_post_a_s1.create(args.arch, num_features=args.features, dropout=args.dropout, num_classes=args.num_clusters)
    model_2_ema = models_post_a_s1.create(args.arch, num_features=args.features, dropout=args.dropout, num_classes=args.num_clusters)
