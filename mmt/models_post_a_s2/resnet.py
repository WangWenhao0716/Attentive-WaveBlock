...
import numpy as np
import random
from .non_local_dot_product import *
...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
        ...
        self.non_local_1 = NONLocalBlock2D(512, sub_sample=False, bn_layer=True)
        self.non_local_2 = NONLocalBlock2D(1024, sub_sample=False, bn_layer=True)
