...
from mmt import models_post_a_source
...
def main_worker(args):
    ...
    # Create model
    model = models_post_a_source.create(args.arch, num_features=args.features, dropout=args.dropout, num_classes=num_classes)
    model.cuda()
...
if __name__ == '__main__':
    ...
    parser.add_argument('-a', '--arch', type=str, default='resnet50',
                        choices=models_post_a_source.names())
