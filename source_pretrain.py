...
from awb import models_source
from awb.trainers import PreTrainer
...
from awb.utils.lr_scheduler import WarmupMultiStepLR
...
def main_worker(args):
    ...
    # Create model
    model = models_source.create(args.arch, num_features=args.features, dropout=args.dropout, num_classes=num_classes)
    model.cuda()
